...
describe("ownership-relation-community-collection", async () => {
  ...
  describe("Get /ownershipRelations", () => {
    it("should Get ownershipRelations", done => {
      chai
        ...
        .get("/relations/ownerships/community/collection")
        .end((err, res) => {
          if (err) done(err);
  ...
  describe("Post /ownershipRelations", () => {
    it("should Post ownershipRelations", done => {
      chai
        .request(url + ownershipRelationPort)
        .post("/relations/ownerships/community/collection")
        .send({
          CommunityId: 6,
          CollectionId: 3,
          OwnershipTypeId: 1
  ...
  describe("Get /ownershipRelations", () => {
    it("should Get specific relations", done => {
      chai
        .request(url + ownershipRelationPort)
        .get("/relations/ownerships/community/2/collection/8")
        .end((err, res) => {
          if (err) done(err);
          expect(res).to.have.status(200);
          expect(res.body).to.be.an("object");
    ...
    it("should return 404 on inexistant community", done => {
      chai
        .request(url + ownershipRelationPort)
        .get("/relations/ownerships/community/20/collection/8")
        .end((err, res) => {
          if (err) done(err);
    ...
    it("should return 404 on inexistant resource", done => {
      chai
        .request(url + ownershipRelationPort)
        .get("/relations/ownerships/community/2/collection/22")
        .end((err, res) => {
          if (err) done(err);
          expect(res).to.have.status(404);
          expect(res.body).to.deep.equal({});
    ...
    it("should return 404 on invalid url", done => {
      chai
        .request(url + ownershipRelationPort)
        .get("/relations/ownerships/community/2/collection/null")
        .end((err, res) => {
          if (err) done(err);
          expect(res).to.have.status(404);
          expect(res.body).to.deep.equal({});
  ...
  describe("Put /ownershipRelations", () => {
  ...
  describe("Delete /ownershipRelations", () => {
    it("should Delete specific relations", done => {
      chai
        .request(url + ownershipRelationPort)
        .delete("/relations/ownerships/community/8/collection/2")
        .then(res => {
          expect(res).to.have.status(200);
          expect(res.body).to.be.an("object");
          expect(res.body).to.containSubset({
        ...
        .then(function(res) {
          chai
            .request(url + ownershipRelationPort)
            .get("/relations/ownerships/community/8/collection/2")
            .end((err, res) => {
              if (err) done(err);
              expect(res).to.have.status(404);
              done();
    ...
    it("should return 404 on inexisting realtion Delete specific relations", done => {
      chai
        .request(url + ownershipRelationPort)
        .delete("/relations/ownerships/community/2/collection/2")
        .end((err, res) => {
          if (err) done(err);
          expect(res).to.have.status(404);
          expect(res.body).to.deep.equal({});
